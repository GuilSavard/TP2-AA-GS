...
public class TestOuvrage {
    ...
    public void testOuvrages() {
        ...
        Ouvrage livre2 = new OuvrageAudio("Tout va bien", albertine, LocalDate.now(), -10, 231, OuvrageAudio.Format.Numerique);
        System.out.println(livre2);

        livre2 = new OuvragePapier("Tout va bien", albertine, LocalDate.now(), 20, 23);
        System.out.println(livre2);
        ...
        Ouvrage livre4 = new OuvragePapier("Test", new Auteur("A", "B", "Etats-Unis"),  LocalDate.now(), 5, 2);

        System.out.println("\n-----Tests de la  méthode equals()-----------");
        //Deux ouvrages égaux
        Ouvrage livre5 = new OuvragePapier("Test", new Auteur("A", "B", "Etats-Unis"),  null, 5,6);
        Ouvrage livre6 = new OuvragePapier("Test", new Auteur("A", "B", "Etats-Unis"),  LocalDate.now(), 10, 4);
        //Un qui ne l'est pas
        Ouvrage livre7 = new OuvragePapier("Test", new Auteur("Z", "B", "Etats-Unis"),  LocalDate.now(), 5,5);
